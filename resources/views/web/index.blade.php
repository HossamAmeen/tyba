		...
		<section class="mission padding">
			<div class="container">
				<div class="row text-center">
					...
					<p class="content">
						مستشفى طيبة رويال بسوهاج هى أحدى الموسسات الرائدة في المجال الطبي والصحي  تأسست على يد نخبة كبيرة من الأساتذة و المتخصصين لتكون صرحا رائدا ومتميزا فى سوهاج خاصة في صعيد مصر عامة
					</p>
