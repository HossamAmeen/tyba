                                        ...
                                        <table class="table table-bordered table-striped table-bottomless" id="ls-editable-table">
                                            <thead>
                                                ...
                                                <tr>
                                                    <td>{{$i++}}</td>
                                                    <td>
                                                        <a href="{{url('/admin/video/'.$service->id.'/edit')}}"
                                                            
                                                             aria-pressed="true">{{$service->name}} </a>
                                                    </td>
                                                    <td>{{$service->path}}</td>
                                                    ...
                                                    <td >
                                                            <a href="{{url('/admin/video/'.$service->id.'/edit')}}" class="btn btn-info">تحديث</a>
                                                            <a href="{{url('/admin/video/'.$service->id.'/delete')}}" class="btn btn-danger check">حذف</a>
