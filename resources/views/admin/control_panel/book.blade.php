...
<section id="min-wrapper">
    <div id="main-content">
        <div class="container-fluid">
            ...
            <form action="{{url('admin/books')}}" class="ls_form" style="padding: 2% 0% 5% 10%">
                <div class="form-group row">
                    {{-- <div class="col-xs-2">
                        <label for="ex1">من</label>
                        <input type="date" name="from_date" id="ex1" @if (isset($from_date)) value="{{$from_date}}" @endif>
                    </div> --}}
                    <div class="col-xs-2">
                        <label for="ex1">من</label>
                        <input class="form-control" id="ex1" name="from_date" type="date" @if (isset($from_date)) value="{{$from_date}}" @endif>
                      </div>
                      <div class="col-xs-2">
                        <label for="ex1">إلي</label>
                        <input class="form-control" id="ex1" name="to_date"  type="date" @if (isset($to_date)) value="{{$to_date}}" @endif>
                      </div>
                    {{-- <div class="col-xs-2">
                        <label for="ex1">إلي</label>
                        <input type="date" name="to_date" @if (isset($to_date)) value="{{$to_date}}" @endif>
                    </div> --}}
                </div>
                ...
                {{-- <input type="submit" name="" id="" value="عرض" class="col-lg-4 col-lg btn-primary"> --}}
                <input type="submit" value="تحميل ملف excel" class="btn btn-info" formaction="{{url('/admin/books/download')}}">
            </form>
            {{-- <a href="{{url('/admin/books/download')}}" class="btn btn-info">excel download</a> --}}
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <span class="panel-title">الحجوزات</span>
                                ...
                                <table class="table table-bordered table-striped table-bottomless"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($book->status == 0 )
                                                <a href="{{url('/admin/books/change-status/'.$book->id)}}"
                                                    class="btn btn-info">موافق</a>
                                                @else
                                                <span href="#" class="btn btn-info">تم الحجز</span>

                                                @endif
                                                <a href="{{url('/admin/books/'.$book->id.'/delete')}}"
                                                    class="btn btn-danger check">حذف</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
        ...
        <div class="tab-pane" id="settingTab">
            ...
            <div class="setting-box">
                ...
                <div class="setting-box-content">
                    <ul>
                        <li><span class="pull-left">Online status: </span><input type="checkbox" class="js-switch-red"
                                checked /></li>
            ...
            <div class="setting-box">
                ...
                <div class="setting-box-content">
                    ...
                    <div class="progress progress-striped active">
                        <div class="progress-bar ls-yellow-progress six-sec-ease-in-out" aria-valuetransitiongoal="80">
                        </div>
                    </div>
                    <h5>Create New User</h5>
                    <div class="progress progress-striped active">
                        <div class="progress-bar ls-red-progress six-sec-ease-in-out" aria-valuetransitiongoal="100">
                        </div>
                    </div>
                </div>
            </div>
