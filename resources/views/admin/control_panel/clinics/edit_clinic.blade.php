                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form action="{{url('admin/clinic/'.$id)}}" method="post"
                                    class="form-horizontal ls_form" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    {{method_field('PUT')}}
                                    @if ($errors->any())
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" name="name"
                                                ...
                                                value="{{ $name}}" data-bv-stringlength="true"
                                    ...
                                    {{-- <div class="form-group">
                                        <label class="col-lg-3 control-label">الدكتور</label>
                                        <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="goal-user-image">
                                            <img class="rounded" src="{{asset($img)}}" alt="user image" height="15%"
                                                width="15%" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-lg-9 col-lg-offset-3">
                                            <button type="submit" class="btn btn-primary"
                                                onclick="myFunction()">تحديث</button>
                                        </div>
                                    </div>
                                </form>
