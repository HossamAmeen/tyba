            ...
            <div class="row">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">الاطباء</h3>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{url('/admin/doctor/'.$doctor->id.'/edit')}}"
                                             ...
                                             aria-pressed="true">{{$doctor->name}} </a>
                                    </td>
                                    <td>{{$doctor->job}}</td>
                                    ...
                                    @endif
                                    <td >
                                            <a href="{{url('/admin/doctor/'.$doctor->id.'/edit')}}" class="btn btn-info">تحديث</a>
                                            <a href="{{url('/admin/doctor/'.$doctor->id.'/delete')}}" class="btn btn-danger check">حذف</a>
