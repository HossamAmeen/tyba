                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <form action="{{url('admin/clinic')}}" method="post" class="form-horizontal ls_form" enctype="multipart/form-data" >
                                        {{csrf_field()}}   
                                        @if ($errors->any())
                                        ...
                                        <div class="form-group">
                                                <div class="col-lg-9 col-lg-offset-3">
                                                    <button type="submit" class="btn btn-primary" onclick="myFunction()">إضافه</button>
                                                </div>
                                        </div>
                                    </form>
