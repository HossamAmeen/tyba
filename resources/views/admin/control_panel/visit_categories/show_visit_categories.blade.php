                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <span class="panel-title">العيادات</span>
                            <a href="{{url('admin/visit-categories/create')}}"> <button class="alert-success"> <i
                                ...
                                <table class="table table-bordered table-striped table-bottomless"
                                    ...
                                    <tbody>
                                        <?php
                                                    $i=1;
                                                    ?>
                                        @foreach ($visit_categories as $clinic)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{url('/admin/visit-categories/'.$clinic->id.'/delete')}}"
