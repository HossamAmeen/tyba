                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    <a href="{{url('admin/clinic/create')}}">  <button class="alert-success"> <i class="fa fa-plus"></i> </button> </a>
                                        ...
                                        <table class="table table-bordered table-striped table-bottomless" id="ls-editable-table">
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    @endif
                                                    <td >
                                                            <a href="{{url('/admin/clinic/'.$clinic->id.'/edit')}}" class="btn btn-info">تحديث</a>
                                                            <a href="{{url('/admin/clinic/'.$clinic->id.'/delete')}}" class="btn btn-danger check">حذف</a>
