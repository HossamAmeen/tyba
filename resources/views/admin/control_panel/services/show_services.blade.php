                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span class="panel-title">الخدمات</span>
                                    <a href="{{url('admin/service/create')}}">  <button class="alert-success"> <i class="fa fa-plus"></i> </button> </a>
                                            ...
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                      ...
                                                      <i class="fas {{$service->icon}} fa-5x"></i>
                                                        </li>
