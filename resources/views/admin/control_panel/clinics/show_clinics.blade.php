                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <a href="{{url('admin/clinic/create')}}"> <button class="alert-success"> <i
                                ...
                                <table class="table table-bordered table-striped table-bottomless"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$i++}}</td>
                                            <td>
                                                <a href="{{url('/admin/clinic/'.$clinic->id.'/edit')}}"
                                                    aria-pressed="true">{{$clinic->name}} </a>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{url('/admin/clinic/'.$clinic->id.'/delete')}}"
