...
<body class="">
                            ...
                            <li>
                                <a href="javascript:void(0)">
                                    <div class="goal-user-image">
                                        <img class="rounded" src="{{asset('images/demo/avatar-80.png')}}" alt="user image" />
                                    </div>
                            ...
                            <li>
                                <a href="javascript:void(0)">
                                    <div class="email-top-image">
                                        <img class="rounded" src="src="{{asset('images/demo/avatar-80.png')}}"" alt="user image" />
                                    </div>
    ...
    <section id="main-container">
        ...
        @include('admin._master.left-nav')
