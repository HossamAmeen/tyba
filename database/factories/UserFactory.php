...
$factory->define(App\Event::class , function (Faker $faker){
    ...
    return[ 
        ...
        'name' => "events",
        'description'  => " تتشرف مستشفى طيبة باستضافة نخبة من افضل الأطباء فى مصر بشكل دورى لاجراء العمليات المتخصصة والاشراف على الحالات الان يمكنك معرفة تخصصات وموعد الزياراة من خلال الموقع ",
