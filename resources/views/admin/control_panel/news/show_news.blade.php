                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <span class="panel-title">الأخبار</span>
                            <a href="{{url('admin/news/create')}}"> <button class="alert-success"> <i
                            ...
                            <div class="ls-editable-table table-responsive ls-table">
                                <table class="table table-bordered table-striped table-bottomless"
                                    ...
                                    <tbody>
                                        ...
                                        $i=1;
                                        ?>
                                        @foreach ($news as $doctor)


                                        <tr>
                                            <td>{{$i++}}</td>
                                            <td>
                                                <a href="{{url('/admin/news/'.$doctor->id.'/edit')}}"
                                                    aria-pressed="true">{{$doctor->title}} </a>
                                            </td>
                                            <td>{{$doctor->ar_sub_des}}</td>
                                            ...
                                            <td>
                                                <a href="{{url('/admin/news/'.$doctor->id.'/edit')}}"
                                                    class="btn btn-info">تحديث</a>
                                                <a href="{{url('/admin/news/'.$doctor->id.'/delete')}}"
